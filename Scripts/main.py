import pandas as pd
from Scripts.language_model.language_model import pipeline_model
from Scripts.filter_user.ask_user import ask_all, ask_company, ask_keywords
...
def searchmodel_main(df, model=None, tokenizer=None, top_n=10 ) -> pd.DataFrame:
    ...
    df.loc[index, "BUSINESS_DESCRIPTION"] = add_to_description_keywords + df.loc[index, "BUSINESS_DESCRIPTION"]
